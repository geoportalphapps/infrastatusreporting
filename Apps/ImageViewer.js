...
Ext.define('Apps.ImageViewer', {
    ...
    initComponent: function () {
        ...
        me.items = [{
            ...
            items: [{
                ...
                icon: '../../lib/resources/images/imageviewer/stretch_horizontally.png',
                listeners: { click: me.stretchHorizontally, scope: me }
            }, {
                xtype: 'button',
                tooltip: me.tooltips.stretchVertically,
                icon: '../../lib/resources/images/imageviewer/stretch_vertically.png',
                listeners: { click: me.stretchVertically, scope: me }
            }, {
                xtype: 'button',
                tooltip: me.tooltips.stretchOptimally,
                icon: '../../lib/resources/images/imageviewer/stretch_optimally.png',
                listeners: { click: me.stretchOptimally, scope: me }
            }, {
                xtype: 'button',
                tooltip: me.tooltips.zoomIn,
                icon: '../../lib/resources/images/imageviewer/zoom_in.png',
                listeners: { click: me.zoomIn, scope: me }
            }, {
                xtype: 'button',
                tooltip: me.tooltips.zoomOut,
                icon: '../../lib/resources/images/imageviewer/zoom_out.png',
                listeners: { click: me.zoomOut, scope: me }
            }, {
                xtype: 'button',
                tooltip: me.tooltips.rotateClockwise,
                icon: '../../lib/resources/images/imageviewer/arrow_rotate_clockwise.png',
                listeners: { click: me.rotateClockwise, scope: me }
            }, {
                xtype: 'button',
                tooltip: me.tooltips.rotateAntiClockwise,
                icon: '../../lib/resources/images/imageviewer/arrow_rotate_anticlockwise.png',
                listeners: { click: me.rotateAntiClockwise, scope: me }
            },	{
                xtype: 'button',
                //tooltip: me.tooltips.rotateAntiClockwise,
                icon: '../../lib/resources/images/imageviewer/prev.png',
                listeners: { click: me.prevImage, scope: me }
            },  {
                xtype: 'button',
                //tooltip: me.tooltips.rotateAntiClockwise,
                icon: '../../lib/resources/images/imageviewer/next.png',
	...
	nextImage:function(){
		var me=this;
		var image = me.up().down('#imageDisplay');
		len=(me.imageArray.length-1) 
		if (me.ctr < len ){
			me.ctr=me.ctr+1;	
		}
		console.log(me.ctr);
		image.setSrc("../files/" + me.imageArray[me.ctr] ); // in setSrc you can give path of your image
